...
class Positionable(ABC):
    ...
    @abstractmethod
    def __init__(
        self, tag: str, blender_object, quaternion=(1, 0, 0, 0), translation=(0, 0, 0)
    ):
    ...
    def set_position(self, quaternion, translation):
    ...
    def _set_blender_object_position(self, blender_object):
